...
*/var AcceptEventAction=function(a){a=a||{};AcceptEventAction.baseConstructor.call(this,a)};JSFun.extend(AcceptEventAction,Rectangular);AcceptEventAction.prototype.getLinkCentered=function(n,l){if(this._selectedFigure){return AcceptEventAction.base.getLinkCentered.call(this,n,l)}if(n instanceof Point){l=n.getY();n=n.getX()}var h=this.getCentralPoint();var d=h.getX();var c=h.getY();var a,o,g,e;a=this.getX();o=this.getY();g=h.getX();e=this.getY();if(n<d){if(l<c){var b;b=(this.getY()-c)/ (this.getX() - d);
    ...
    Flow.prototype.drop = function (a, d)
    {
        if (this._moved)
        {
            this._checkForNewNodes(a, d); /*http://www.jrromero.net/tools/jsUML2*/
            var b;
    ...
    {
        var a; /*http://www.jrromero.net/tools/jsUML2*/
        a = this._x;
        this._x = this._y;
        this._y = a;
        delete a
    ...
    UMLStereotypedElement.prototype.showStereotypesDialog = function ()
    {
        ...
        var e;
        textField = document.createElement("select"); /*http://www.jrromero.net/tools/jsUML2*/
        e = document.createElement("option");
        e.setAttribute("value", "");
        e.appendChild(document.createTextNode("default"));
        textField.appendChild(e);
    ...
    {
        var b = d.createElement("item"); /*http://www.jrromero.net/tools/jsUML2*/
        if (this._id)
        {
    ...
    JSFun.extend(ObjectActivity, Rectangular); /*http://www.jrromero.net/tools/jsUML2*/
        ...
        if (this._container)
        {
            ...
            else
            {
                if ((d < this._y) || (b > (this._y + this._height)))
                {
                    for (o = 0; o < this.getParent()._nodeChilds.length; o++)
                    {
                        var t = this.getParent()._nodeChilds[o]; /*http://www.jrromero.net/tools/jsUML2*/
    ...
    UnhierarchicalSwimlane.prototype.resetSizeComponentSwimlane = function ()
    {
        ...
        for (var b = 0; b < a.length; b++)
        {
            a[b]._heightComp = (this._orientation) ? (a[b]._components[0]._height + a[b]._components[1]._height) : 0; /*http://www.jrromero.net/tools/jsUML2*/
            a[b]._widthComp = (this._orientation) ? 0 : (a[b]._components[0]._width + a[b]._components[1]._width)
        }
    };
        ...
        if (this._elemA == this._elemB)
        {
            ...
            if (this._selected == 2 || this._selected == 0 || this._selected == g - 1 || (this._selected == -1 && !this._elemA._moved) || this._elemA._resizing)
            {
                if ((n - d) > 0)
                {
                    ...
                    {
                        a = this._elemA.getLinkCentered(d, c - this._elemA.getHeight() / 2); /*http://www.jrromero.net/tools/jsUML2*/
                        p = this._elemA.getLinkCentered(d + this._elemA.getWidth() / 2, c);
                        e = a.getY() - h;
                        e = (e < 20) ? 20 : e;
                        m = n - p.getX();
                    ...
                    else
                    {
                        if (this._selected == 2)
                        {
                            ...
                            if (this._elemA._moved)
                            {
                                ...
                                this._points[0].setPoint(this._points[0]._x + o, this._points[0]._y + l);
                                this._points[4].setPoint(this._points[4]._x + o, this._points[4]._y + l);
                                a = this._points[0]; /*http://www.jrromero.net/tools/jsUML2*/ /*http://www.jrromero.net/tools/jsUML2*/
                                p = this._points[4];
                                this._points[1].setPoint(this._points[1]._x + o, this._points[1]._y + l);
                                this._points[2].setPoint(this._points[2]._x + o, this._points[2]._y + l);
                                this._points[3].setPoint(this._points[3]._x + o, this._points[3]._y + l)
    ...
    GeneralizationSet.prototype._calculateLineEnds = function ()
    {
        ...
        {
            a = this._elemA.getLinkCentered(this._elemB.getCentralPoint());
            p = this._elemB.getLinkCentered(this._elemA.getCentralPoint()); /*http://www.jrromero.net/tools/jsUML2*/
            this._points[0] = a;
            this._points[1] = p;
            this._points[1] = new Point(this.getCentralPoint());
            this._points[2] = new Point(this.getCentralPoint());
